...
def mostra_start(chat_id,name):
    ...
    testo = testo.replace('&1', str(emoji.emojize(':sunglasses:', use_aliases=True).encode('utf-8')))
    testo = testo.replace('&2', str(emoji.emojize(':gear:', use_aliases=True).encode('utf-8')))
    testo = testo.replace('&3', str(emoji.emojize(':v:', use_aliases=True).encode('utf-8')))
    testo = testo.replace('&4', str(emoji.emojize(':arrows_counterclockwise:', use_aliases=True).encode('utf-8')))
    testo = testo.replace('&5', str(emoji.emojize(':book:', use_aliases=True).encode('utf-8')))
...
def mostra_info(chat_id):
    ...
    testo = testo.replace('&1', str(emoji.emojize(':arrows_counterclockwise:', use_aliases=True).encode('utf-8')))
    testo = testo.replace('&2', str( emoji.emojize(':book:', use_aliases=True).encode('utf-8')))
    bot.sendMessage(chat_id, testo, parse_mode='HTML')
